...
void IEEE14443Control::walletCharge(int money)
{
    walletMoney = walletMoney-money;
    return;
}

void IEEE14443Control::walletRecharge(int money)
{
    walletMoney = walletMoney + money;
    return;
}

int IEEE14443Control::getWallet()
{

    return walletMoney;
}

int IEEE14443Control::setWallet(int money)
{
    walletMoney = money;
    return walletMoney;
}
