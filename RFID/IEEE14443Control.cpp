...
void IEEE14443Control::onRecvedPackage(QByteArray pkg)
{
    ...
    case IEEE14443Package::SelectCard:
        // response for process_selCardBtn()
        if(status == 0)
        {
			process_authCheckBtn();
        }
        else
        {
    ...
    case IEEE14443Package::Authentication:
        // response for process_authCheckBtn()
        if(status == 0)
		{
...
void IEEE14443Control::process_authCheckBtn()
{
    QByteArray authInfo;
...
void IEEE14443Control::process_readBtn()
{
...
void IEEE14443Control::process_writeBtn()
{
